...
if os.name == 'nt':
    ...
    path = homepath+'/Users/terencephilippon/Python/VIDEO/Video Data/IMG_3906.MOV'

# ===================================================================

### Read from the video camera (Mac OS)
camera = cv2.VideoCapture('/Users/terencephilippon/Python/VIDEO/Video Data/IMG_3906.MOV')
...
#==============================================================================
    ...
    # Save count number to asciixyz & Resize ASCII.
    print("frame_counter = "+str(frame_counter))
    ASCIIxyz[frame_counter,0] = 0
    ASCIIxyz[frame_counter,1] = 0
    ASCIIxyz[frame_counter,2] = number
    ASCIIxyz = np.vstack([ASCIIxyz, np.zeros((1,3))])
...
np.savetxt('/Users/terencephilippon/Python/VIDEO/Video Data/data.txt',matrix, fmt='%2f',delimiter=',')
np.savetxt('/Users/terencephilippon/Python/VIDEO/Video Data/points.txt',points_stack, fmt='%2f',delimiter=' ')
...
#    matrixMask = scipy.ndimage.morphology.binary_dilation(matrix, structure=kernel)
